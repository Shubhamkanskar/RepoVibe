...
export default function Review() {
  ...
  const tweets = [
    ...
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1943308327573950466/qlQX0Xv0_400x400.jpg",
      content: "damn the UI",
      date: "July 18, 2025",
      isVerified: true,
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1948384156129566720/bodOvmVQ_400x400.jpg",
    ...
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1952757539319246849/-m0L3_Sz_400x400.jpg",
      content: "well built",
      date: "July 18, 2025",
      isVerified: true,
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1915323511914336256/YZoU50OY_400x400.jpg",
    ...
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1955986645083414530/TuSQgeNX_400x400.jpg",
      content:
        "Fk @ajeetunc this is dem good\nBtw how about putting infinity scroll",
      date: "July 18, 2025",
      isVerified: false,
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1830336479815483392/MqGG4qM4_400x400.jpg",
    ...
    },
    {
      ...
      tweetUrl:
        "https://twitter.com/iamAdityaAnjana/status/1946272068607324318",
      profileImage:
        "https://pbs.twimg.com/profile_images/1944402318729854976/SgGE8uXl_400x400.jpg",
    ...
    },
    {
      ...
      profileImage:
        "https://pbs.twimg.com/profile_images/1959707473130160128/_1V3XIxs_400x400.jpg",
  ...
  return (
    <main className="relative w-full bg-black text-white flex flex-col items-center justify-center py-20">
      <section className="relative w-full px-4 sm:px-8 md:px-16 lg:px-32 xl:px-44  flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col mb-14 items-center justify-center gap-4">
            <header className="text-2xl flex flex-col items-center justify-center gap-3 sm:text-3xl md:text-4xl lg:text-5xl font-medium leading-[100%] animate-fade-in w-fit text-center">
              ...
              <p className="text-neutral-400 font-medium leading-5 transition duration-300 text-sm sm:text-base">
                Real feedback from real developers <br /> see what the community
                is saying about RepoVibe.
              </p>
            </header>
          </div>
        </div>
        ...
        <div
          className={`mt-16 flex flex-col items-center gap-4 transition-all duration-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{ transitionDelay: "0.8s" }}
        >
          <p className="text-neutral-400 font-medium text-sm sm:text-base text-center">
            Join hundreds of developers already using RepoVibe
          </p>
