...
const navLinks = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Report Bug",
        link: "https://github.com/Shubhamkanskar/repovibe/issues/new",
        icon: Bug,
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "X (Twitter)",
        link: "https://x.com/Shubham_kanaska",
        icon: Twitter,
      },
      {
        name: "GitHub",
      ...
      { name: "Email", link: "mailto:shubhamkanaskar75@gmail.com", icon: Mail },
    ],
  },
];
...
export default function NavLinks({
  ...
  return (
    <div
      className={`sm:flex flex-col mt-16 sm:mt-10 gap-5 sm:px-1 py-1 ${
        isOpen ? "" : "hidden"
      }`}
    >
      {navLinks.map((group) => (
